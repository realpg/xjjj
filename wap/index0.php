    ...
    <div class="page page-current repair-page">
        ...
        <div class="content ticket-content native-scroll">
            ...
            <div class="main-wap">
                <!-- 活动亮点开始 -->
                <div class="activity">
                    <div class="tit"><img src="./images/tit-1.png"></div>
                ...
                <div class="cooperate repair-cooperate">
                    <div class="tit">
                        <img src="./images/tit-5.png">
                    </div>
                    <div class="nav">
                        <div class="nav-fo" id="my-nav">
                            <div class="content-padded grid-demo">
                                <div class="nav-li content-inner native-scroll" id="navScroller" scroll="no" data-toggle="scroller">
                                    <div class="row clearfix repair-clearfix">
                                        <?php
                    ...
                    <div class="nav-con repair-nav-con">
                        <?php
                        foreach ($menu_rows as $k=>$menu_row)
                        {
                            ?>
                            <ul class="nav-con-in clearfix" <?=$k==0?"style='display:block;'":""?>>
                                ...
                                ?>
                                <li class="more more-2" style="width:100%;height:20px;background: none;">
                                    <a href="product-<?=$product_level?>.html" style="background: none;color:#fff;">查看更多&gt;&gt;</a>
                                </li>
                            </ul>
                            <?php
                        }
