...
<html class="pixel-ratio-2 retina android android-6 android-6-0"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script type="text/javascript" async="" src="./华夏家博_files/vds.js"></script>
    ...
    <link href="./css/layer.css" type="text/css" rel="styleSheet" id="layermcss"></head>
<body>

<script type="text/javascript">
    _taq.push({convert_id:"59090614719", event_type:"form"})
</script>

<div class="page-group">
    <div class="page page-current">
        <header class="bar bar-nav">
            <button class="button button-link button-nav pull-left button-back">
                <span class="icon icon-left"></span>
            </button>
            <h1 class="title">报名成功</h1>
        </header>
        <div class="content native-scroll" deep="2">
