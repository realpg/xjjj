...
?>
<form action="ticket-updatedb.php" method="post" enctype="multipart/form-data">
    ...
    <div class="formbody">
        ...
        <ul class="forminfo">
            <li>
                <label>免费索票：</label>
                <input type="text" name="menu_title" id="menu_title" class="dfinput" value="免费索票" readonly />
            </li>
            <li>
                <label>PC端图片：</label>
