...
require_once ("include-power.php");//引入权限判断
    ...
    { 
        ...
        $eventname=$row['power_name'];
        ////
        $sql = "delete from power where power_id='$id'";
        ...
        if($rows >=1)
        {
            ...
            $Log_event=WORD_DELETE.WORD_POWER."“".$eventname."”".IMPLEMENT_SUCCESS;
        ...
        else
        {
            ///////////
            $Log_name=$_COOKIE['login'];
            $Log_event=WORD_DELETE.WORD_POWER."“".$eventname."”".IMPLEMENT_FAIL;
            $db->edit_list("insert into log (Log_name,Log_event)"
                    . "values('$Log_name','$Log_event')");
            ////////////
