...
{
    $image_width=$image_width_7*5;
    $image_height=$image_height_7*5;
}
else if($id==8)
{
    $image_width=$image_width_8*5;
    $image_height=$image_height_8*5;
}
else if($id==9)
{
    $image_width=$image_width_9*5;
    $image_height=$image_height_9*5;
}
else if($id==10)
{
