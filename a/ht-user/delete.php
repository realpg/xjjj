...
require_once ("include-power.php");//引入权限判断
    ...
    { 
        $id = $_REQUEST['id'];
        /////
        $row=$db->query_list_id("select * from user where user_id=$id");
        $eventname=$row['user_name'];
        ////
        ...
        if($rows >=1)
        {
            ...
            $Log_event=WORD_DELETE.WORD_USER."“".$eventname."”".IMPLEMENT_SUCCESS;
        ...
        else
        {
            ///////////
            $Log_name=$_COOKIE['login'];
            $Log_event=WORD_DELETE.WORD_USER."“".$eventname."”".IMPLEMENT_FAIL;
            $db->edit_list("insert into log (Log_name,Log_event)"
                    . "values('$Log_name','$Log_event')");
            ////////////
