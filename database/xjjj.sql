...
CREATE TABLE `coupon` (
  ...
  `coupon_title` varchar(255) DEFAULT NULL COMMENT '标题',
...
INSERT INTO `image` VALUES (1,'版头','upload/image/201709011725528860.jpg',1,1),(3,'现场攻略','upload/image/201711201453393590.png',0,3),(4,'服务保障','upload/image/201708251622164628.png',1,4),(5,'手机端版头','upload/image/201708231534049663.jpg',1,5),(6,'手机端服务保障','upload/image/201708231805193842.png',1,6),(7,'右侧浮窗图片','upload/image/201708251613454227.jpg',1,7),(8,'底部浮窗——左图','upload/image/201708291414438709.png',1,8),(9,'底部浮窗——中图','upload/image/201708291425039900.png',1,9),(10,'底部浮窗——右图','upload/image/201711201114536561.png',1,10),(11,'手机端主会场','upload/menu/201708301438526858.jpg',1,11),(12,'PC端走马灯','http://oysd3pbqr.bkt.clouddn.com/201711201454218112.png',1,2),(13,'PC端标题背景图','upload/image/201709081735431172.png',1,12),(14,'手机端标题背景图','upload/image/201709081800055850.png',1,13);
...
INSERT INTO `leaveword_details` VALUES (1,145);
...
CREATE TABLE `light` (
  ...
  `light_show` int(11) DEFAULT NULL COMMENT '是否显示',
...
INSERT INTO `light` VALUES (27,'现金免单','upload/light/201708231201414085.png','当日累积消费满3000元，可砸金蛋一个，最高千元现金限时抢。',0,0),(28,'2倍家电礼','upload/light/201708231203577763.png','当日累积消费满500元，即可享受满就送礼品翻倍送。',0,0),(29,'5元夺家居','upload/light/201708231206095753.png','无需消费，5元认购千元家居',0,NULL),(32,'赢大奖','upload/light/201708231204527480.png','当日累积消费满3000元，可领抽奖券一张，下单狂抽电冰洗',0,NULL),(33,'工厂爆品','upload/light/201708231206188303.png','百余工厂爆品限时专供，建材家具低至一折起',0,NULL),(34,'签到礼','upload/light/201708231205435690.png','凭短信前500名到店领取签到礼品',0,NULL);
...
CREATE TABLE `log` (
  ...
  PRIMARY KEY (`Log_id`)
) ENGINE=MyISAM AUTO_INCREMENT=2190 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='系统日志';

#
# Data for table "log"
#

INSERT INTO `log` VALUES (2153,'admin','登录成功','2017-11-20 09:07:19'),(2154,'admin','编辑导航“优惠券”成功','2017-11-20 09:08:03'),(2155,'admin','编辑导航“产品展示”成功','2017-11-20 09:08:43'),(2156,'admin','编辑导航“产品展示”成功','2017-11-20 09:14:48'),(2157,'admin','编辑导航“产品展示”成功','2017-11-20 09:14:58'),(2158,'admin','编辑导航“品牌活动区”成功','2017-11-20 09:15:09'),(2159,'admin','编辑导航“活动内容”成功','2017-11-20 09:16:40'),(2160,'admin','编辑“现场攻略”图片成功','2017-11-20 09:17:22'),(2161,'admin','编辑导航“产品展示”成功','2017-11-20 09:29:50'),(2162,'admin','编辑导航“产品展示”成功','2017-11-20 09:31:40'),(2163,'admin','编辑活动亮点“现金免单”成功','2017-11-20 09:40:58'),(2164,'admin','编辑活动亮点“现金免单”成功','2017-11-20 09:42:24'),(2165,'admin','编辑活动亮点“现金免单”成功','2017-11-20 09:49:36'),(2166,'admin','编辑活动亮点“现金免单”成功','2017-11-20 09:50:08'),(2167,'admin','编辑活动亮点“2倍家电礼”成功','2017-11-20 09:50:19'),(2168,'admin','编辑活动亮点“现金免单”成功','2017-11-20 09:52:53'),(2169,'admin','编辑活动亮点“2倍家电礼”成功','2017-11-20 09:54:23'),(2170,'admin','编辑图片失败','2017-11-20 11:02:09'),(2171,'admin','编辑图片失败','2017-11-20 11:05:41'),(2172,'admin','编辑“底部浮窗——右图”图片成功','2017-11-20 11:14:53'),(2173,'admin','编辑图片失败','2017-11-20 11:23:04'),(2174,'admin','编辑“PC端走马灯”图片成功','2017-11-20 11:41:12'),(2175,'admin','编辑“PC端走马灯”图片成功','2017-11-20 11:43:07'),(2176,'admin','编辑“PC端走马灯”图片失败','2017-11-20 11:43:12'),(2177,'admin','编辑“现场攻略”图片成功','2017-11-20 11:43:43'),(2178,'admin','编辑“现场攻略”图片成功','2017-11-20 11:44:06'),(2179,'admin','编辑“现场攻略”图片成功','2017-11-20 11:44:15'),(2180,'admin','登录成功','2017-11-20 13:13:29'),(2181,'admin','登录成功','2017-11-20 14:53:18'),(2182,'admin','编辑“现场攻略”图片成功','2017-11-20 14:53:39'),(2183,'admin','编辑“PC端走马灯”图片成功','2017-11-20 14:54:23'),(2184,'admin','编辑“PC端走马灯”图片成功','2017-11-20 14:54:28'),(2185,'admin','编辑分会场失败','2017-11-20 15:10:21'),(2186,'admin','编辑分会场失败','2017-11-20 15:10:49'),(2187,'admin','编辑分会场失败','2017-11-20 15:11:18'),(2188,'admin','编辑“”分会场成功','2017-11-20 15:12:29'),(2189,'admin','编辑“”分会场失败','2017-11-20 15:17:15');
